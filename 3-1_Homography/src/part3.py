...
if __name__ == '__main__':
    ...
    h, w, c = (500, 500, 3)
    dst_1 = np.zeros((h, w, c))#float64
    dst_2 = np.zeros((h, w, c))#float64
    dst_corns = np.array([[0, 0], [w, 0], [w, h], [0, h]])

    # TODO: call solve_homography() & warping
    H_1 = solve_homography(corners1, dst_corns)
    output3_1 = warping(secret1, dst_1, H_1, 0, h, 0, w, direction='b')
    
    H_2 = solve_homography(corners2, dst_corns)
    output3_2 = warping(secret2, dst_2, H_2, 0, h, 0, w, direction='b')
